...
<section id="schedulesSection" class="content-section active block">
    <div class="mb-8 pt-8 w-full">
        ...
        <div class="flex flex-col md:flex-row justify-between items-center mb-10 gap-6">
            ...
            <x-button variant="outline" class="!px-8 !py-3 !text-lg !font-extrabold rounded-full transition-all whitespace-nowrap" onclick="openModal('schedules')">
                Add Schedule
            </x-button>
        </div>
        ...
        <div class="filter-section mb-6">
            <div class="custom-dropdown" id="scheduleVisualFilterDropdown">
                <div class="custom-dropdown-selected" onclick="toggleCustomDropdown(event, 'scheduleVisualFilterDropdown')">
