...
class DefaultCurriculum
{
     ...
     * Returns ONLY the subjects for the specified semester term.
     * Summer term returns an empty array.
     *
    ...
    private static function firstSemesterSubjects(): array
    {
        return [
            ...
            // ──── Second Year ───────────────────────────────────────
            ['subject_code' => 'GE-113',  'subject_name' => 'Living in IT Era (Elective)',                                                 'year_level' => 2],
            ...
            ['subject_code' => 'IT-132L', 'subject_name' => 'Information Assurance and Security II',                                       'year_level' => 4],
